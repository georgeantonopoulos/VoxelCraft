...
// Self-contained verification script using the NEW meshing logic
// Copies relevant logic from: constants.ts, noise.ts, mesher.ts (FIXED), terrainService.ts
...
const MaterialType = { AIR: 0, STONE: 1, DIRT: 2, GRASS: 3, SAND: 4, SNOW: 5, BEDROCK: 6, WATER: 7 };
...
if (matches > 0 && mismatches === 0) {
    console.log("VERIFICATION SUCCESS: Vertices align perfectly.");
} else {
